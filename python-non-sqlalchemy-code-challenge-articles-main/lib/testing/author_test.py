...
class TestAuthor:
    ...
    articles_author_1 = author_1.articles()
    articles_author_2 = author_2.articles()

    if articles_author_1:  # Check if the list is not empty
        assert isinstance(articles_author_1[0], Article)

    if articles_author_2:  # Check if the list is not empty
        assert isinstance(articles_author_2[0], Article)
    ...
    def test_has_many_magazines(self):
        ...
        # Creating articles and associating them with the author and magazines
        ...
        # Checking if the author has magazines associated with them
        assert magazine_1 in author_1.magazines()
        assert magazine_2 in author_1.magazines()
        assert magazine_3 in author_1.magazines()
